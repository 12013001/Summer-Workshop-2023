...
parser.add_argument("--video_file", default="cxk.mp4", help="Input Video")
...
if MODE is "COCO":
    protoFile = "./data/pose_deploy_linevec.prototxt"
    weightsFile = "./data/pose_iter_440000.caffemodel"
    nPoints = 18
